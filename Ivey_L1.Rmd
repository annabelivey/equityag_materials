...
plot_oc_2010 <- ggplot(data = subset_data_oc, mapping =aes(x= COUNTY_2010SVI, y=upward_mobility_rate_2010)) + geom_boxplot() 
print(plot_oc_2010)
          
#making the 2020 boxplot
plot_oc_2020 <- ggplot(data = subset_data_oc, mapping =aes(x= COUNTY_2010SVI, y=upward_mobility_rate_2020)) + geom_boxplot() 
print(plot_oc_2020)
...
#outliers 
#There are outliers in both data sets at approximately 17 
